...
export default async function AgentPromptPage({ params }: Props) {
  ...
  return (
    <div className="pb-safe-or-8 mx-auto flex min-h-0 w-full max-w-2xl flex-1 flex-col gap-6 p-4 sm:p-8">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground text-sm">system instructions for every conversation.</p>
      </div>
      <AgentPromptForm agentId={agentId} initialSystemPrompt={agent.systemPrompt} />
    </div>
  );
}
