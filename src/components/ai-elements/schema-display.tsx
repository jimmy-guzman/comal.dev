...
export const SchemaDisplay = ({
  ...
  return (
    <SchemaDisplayContext.Provider value={contextValue}>
      <div
        className={cn("overflow-hidden rounded-none border bg-background", className)}
        {...props}
      >
        {children ?? (
          <>
...
export const SchemaDisplayExample = ({
  ...
  <pre
    className={cn("mx-4 mb-4 overflow-auto rounded-none bg-muted p-4 font-mono text-sm", className)}
    {...props}
  >
    {children}
  </pre>
